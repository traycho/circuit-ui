...
Refer to the [Fonts](Styles|Fonts) documentation to learn how to define and load custom fonts in a performant way.
...
The [static CSS](Styles|Static-CSS) does not include a grid system.

Refer to the [grid](Styles|Grid) documentation for an overview of the grid system.
