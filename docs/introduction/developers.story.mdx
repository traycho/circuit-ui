...
You can create presentations with [circuit-deck](https://github.com/sumup/circuit-deck), a [mdx-deck](https://github.com/jxnblk/mdx-deck) starter with Circuit UI built-in.
